...
def f_to_c(fahrenheit)
    return puts "#{fahrenheit} degrees Fahrenheit is equal to #{(fahrenheit - 32) * 5/9} degrees Celcius"
end

puts "This program converts temperatures from Fahrenheit to Celcius.  Please enter a temperature in Fahrenheit"
